...
\hypersetup{
	pdftitle={Teclado: manual de uso},
...
\begin{tabu}{| >{\itshape}X[5, l] | X[14, l] |}
	\multicolumn{2}{c}{{\bfseries Archivos resultado} en {\itshape bin}} \\ \sep
	...
	\multicolumn{2}{c}{} \\
	\multicolumn{2}{c}{{\bfseries Repertorio de muestra} en {\itshape repertorio}} \\ \sep
	...
	\multicolumn{2}{c}{} \\
	\multicolumn{2}{c}{{\bfseries Código fuente de descripción hardware} en {\itshape src/vhdl}} \\ \sep
...
\begin{tabu}{| >{\itshape}X[3, l] | X[5, l] |}
	\multicolumn{2}{c}{} \\
	\multicolumn{2}{c}{{\bfseries Simulaciones} en {\itshape src/vhdl/pruebas}} \\ \sep
	...
	\multicolumn{2}{c}{} \\
	\multicolumn{2}{c}{{\bfseries Códigos de utilidad} en {\itshape src/util}} \\ \sep
	bmptovhd.cpp & Conversor de BMP a VHDL \\ \sep

	\multicolumn{2}{c}{} \\
	\multicolumn{2}{c}{{\bfseries Manipulador de archivos FLAN} en {\itshape src/mflan}} \\ \sep
...
\begin{tabu}{| >{\itshape}X[3, l] | X[5, l] |}
	\multicolumn{2}{c}{{\bfseries Cargador/descargador de archivos} en {\itshape src/eurotas}} \\ \sep
...
\begin{figure}[ht] \centering
	\includegraphics[scale=1.7]{keyboard.pdf}
...
\section{¿Qué espero ver?}
	...
	\begin{figure}[ht] \centering
	\includegraphics[scale=.35]{posleds.png} \\
